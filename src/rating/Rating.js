...
export default class Rating extends Component {
  ...
  constructor(props) {
    ...
    this.startingValue = this.props.startingValue;
  }
  ...
  UNSAFE_componentWillReceiveProps = nextProps => {
    if (this.startingValue !== nextProps.startingValue) {
      this.startingValue = nextProps.startingValue;
      this.setCurrentRating(this.startingValue);
    }
  }
